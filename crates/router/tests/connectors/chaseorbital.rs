...
use router::db::domain;
use crate::utils::{self, ConnectorActions};
use test_utils::connector_auth;

#[derive(Clone, Copy)]
struct ChaseorbitalTest;
impl ConnectorActions for ChaseorbitalTest {}
impl utils::Connector for ChaseorbitalTest {
    fn get_data(&self) -> api::ConnectorData {
        use router::connector::Chaseorbital;
        utils::construct_connector_data_old(
            Box::new(Chaseorbital::new()),
    ...
    fn get_name(&self) -> String {
        "chaseorbital".to_string()
    }
}

static CONNECTOR: ChaseorbitalTest = ChaseorbitalTest {};
